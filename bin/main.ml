...
let print_description : unit =
  print_endline "This project takes the abstract syntax tree (AST) of a lambda term,";
  print_endline "represents it as a separate lambda term (so-called Morgensen-Scott";
